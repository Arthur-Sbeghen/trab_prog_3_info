...
class MovieController extends Controller
{
    ...
    public function create()
    {
        if (!auth()->user()->is_admin) {
            return redirect()->route('index')->with('alert', ["type" => "error", "message" => "You can't create movies without being an admin"]);
        }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('index')->with('alert', ["type" => "success", "message" => "Movie '" . $data['title'] . "' created successfully!"]);
    }

    public function edit($id)
    {
        if (!auth()->user()->is_admin) {
            return redirect()->route('index')->with('alert', ["type" => "error", "message" => "You can't edit movies without being an admin"]);
        }
    ...
    public function update($id, Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('index')->with('alert', ["type" => "error", "message" => 'Failed to update movie: ' . $error->getMessage()]);
        }

        return redirect()->route('index')->with('alert', ["type" => "success", "message" => "Movie '" . $data['title'] . "' updated successfully"]);
    }

    public function destroy($id)
    {
        if (!auth()->user()->is_admin) {
            return redirect()->route('index')->with('alert', ["type" => "error", "message" => "You can't delete movies without being an admin"]);
        }
        ...
        try {
            ...
            return redirect()->route('index')->with('alert', ["type" => "error", "message" => 'Failed to delete movie: ' . $error->getMessage()]);
        }

        return redirect()->route('index')->with('alert', ["type" => "success", "message" => "Movie '" . $movie['name'] . "' deleted successfully"]);
    }
}