    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <p style="height:100%; font-weight: bold; font-style:italic;justify-content: center; align-content:center; padding:0.5rem; font-size:20px; color: #ffc300">The Picture House</p>
